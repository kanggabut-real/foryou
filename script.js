...
botMsg.innerHTML = "akuuu mauu mintaa maaff dimaafinn ngga??";
step++;

}else if(step === 1){

botMsg.innerHTML = "sayanggg, maafinn akuuu yaa. akuu tauu inii murnii kesalahann akuu karena cemburu nya gajelas padahal kamu udah ngasih penjelasan 😔. akuuu bikinn inii buatt kamuu jugaa, bukan buat mintaa maaff doangg. jadi dimaafin ngga??";
step++;

}else if(step === 2){

botMsg.innerHTML = "fyi aja aku ngerasa akhir akhir ini kita kaya renggang gitu kao chatan, aku gamau kaya waktu itu lagi, aku gamau nyakitin kamu lagi, aku gamau putus lagi. aku mau nya kamu happy teruss, kamu gaboleh sakit hatii sama aku lagi tapi kayanya tadi udah ya.... kamu jangan pergi lagii yaaa pliss kalo kamuu gasuka samaa sifat akuu bilangg ajaa yaa jangan di pendemm teruss, takutnya nanti misskomunikasi. akuu benerann berharapp samaa kamuu beyyy, loveuuuuu sayanggg💙";
}
...
{
src:"sound/sound3.mp3"
},

{
src:"sound/sound4.mp3"
},

{
src:"sound/sound5.mp3"
}
